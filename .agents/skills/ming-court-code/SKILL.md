...
description: "Ming Court Code - structured Codex dev workflow inspired by Ming Dynasty court system. Three modes: 口谕/oral decree for quick tasks, 廷议/court debate for planned work, 早朝/morning assembly for multi-domain parallel work. Trigger: 明廷典, ming court, 朝廷模式, 口谕, 廷议, 早朝, tier up, tier down, dev workflow protocol"
metadata:
  version: "1.1.2"
---
...
以明代朝廷体制规范 Codex 开发流程。三级工作模式按任务复杂度自动适配。用户即天子，CC 即首辅。
